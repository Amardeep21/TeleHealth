...
open class GSImageViewerController: UIViewController {
    ...
    open var backgroundColor: UIColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.2593107877) {
        didSet {
    ...
    override open func viewDidLoad() {
        ...
        setupGesture()
        setupImageHD()
        self.view.backgroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.2593107877)
    ...
    fileprivate func setupImageHD() {
        ...
        let request = URLRequest(url: imageHD, cachePolicy: .reloadIgnoringLocalCacheData, timeoutInterval: 30)
    ...
    @objc fileprivate func pan(_ gesture: UIPanGestureRecognizer) {
        ...
        case .changed:
            ...
            view.backgroundColor = backgroundColor.withAlphaComponent(0.4)
...
class GSImageViewerTransition: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let tempMask = UIView()
        tempMask.backgroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.2593107877).withAlphaComponent(0.4)
